...
@Superthon.ar_cmd(pattern="للكروبات(?: |$)(.*)")
async def gcast(event):
    Superthon = event.pattern_match.group(1)
    if Superthon:
        msg = Superthon
    elif event.is_reply:
        ...
        return
    roz = await edit_or_reply(event, " يتم الاذاعة في الكروبات انتظر لحضه")
    er = 0
    done = 0
...
@Superthon.ar_cmd(pattern="للخاص(?: |$)(.*)")
